...
//int main()
//{
//	//char arr[] = "为何我的眼角常含泪水@那是因为我爱这边土地爱得深沉.com";
//	
//	//char* p = "@.";
//	char arr[]=""
//	char buf[1024] = { 0 };
...
//strerror返回错误码包含所错误信息
//#include<errno.h>
//int main()
//{
//	//error是一个全局的错误码的变量
//	//当c语言的库函数在执行过程中，发生了错误，就会把对应的错误码，赋值到errno中
//	/*char* arr = strerror(errn);
//	printf("%s\n",arr);*/
//	//打开文件
...
//int main()
//{
//	//char ch = toupper('q');//小写转成大写而tolower是大写转小写
//	//putchar(ch);
//	char arr[] = "I AM A SYUDENT";
//	int i = 0;
//	while (arr[i])
//	{
//		if (isupper(arr[i]))//判断是否为大写而islower是判断是否小写
//		{
//			arr[i] = tolower(arr[i]);
//		}
//		i++;
